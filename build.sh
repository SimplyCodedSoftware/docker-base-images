...
#&&
docker buildx build --builder mybuilder --platform linux/amd64 --push -t simplycodedsoftware/php:8.5.3 Debian/PHP/8.5/Fpm \
&& docker buildx build --builder mybuilder --platform linux/amd64 --push -t simplycodedsoftware/nginx-php:8.5.3 Debian/PHP/8.5/Fpm-Nginx