...
docker build -t simplycodedsoftware/php:8.1 Debian/PHP/8.1/Fpm \
&& docker push simplycodedsoftware/php:8.1 \
&& docker build -t simplycodedsoftware/nginx-php:8.1 Debian/PHP/8.1/Fpm-Nginx \
&& docker push simplycodedsoftware/nginx-php:8.1 \
&& docker build -t simplycodedsoftware/php:8.2 Debian/PHP/8.2/Fpm \
&& docker push simplycodedsoftware/php:8.2 \
&& docker build -t simplycodedsoftware/nginx-php:8.2 Debian/PHP/8.2/Fpm-Nginx \
&& docker push simplycodedsoftware/nginx-php:8.2
#\
